...
/* Keymap (Base Layer) Default Layer
   ...
   * |----------------------------------------------------------------|
   * |Fn     |  A|  S|  D|  F|  G|  H|  J|  K|  L|  ;|  '|  Ent  |PgDn|
   * |----------------------------------------------------------------|
   * |Shift   |  Z|  X|  C|  V|  B|  N|  M|  ,|  .|  /|Shift | Up|Fn  |
   * |----------------------------------------------------------------|
   * |Ctrl|Win |Alt |        Space          |Alt|Win|    |Lef|Dow|Rig |
   * `----------------------------------------------------------------'
   */
...
[_BL] = LAYOUT_all(
  ...
  KC_LCTL, KC_LGUI, KC_LALT, XXXXXXX, KC_SPC, XXXXXXX, KC_RALT, KC_RGUI, XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT),  

  /* Keymap Fn Layer
   * ,----------------------------------------------------------------.
   * |~ `|F1 |F2 |F3 |F4 |F5 |F6 |F7 |F8 |F9 |F10|F11|F12|Prt|   |Ins |
   * |----------------------------------------------------------------|
   * |Caps |Mut|VDn|VUp|   |   |   |   |   |   |   |PUp|    |Calc|Home|
   * |----------------------------------------------------------------|
   * |      |Prv|Ply|Nxt|   |   |Lft|Dwn|Up |Rgt|Hom|End|        |End |
   * |----------------------------------------------------------------|
   * |        |   |   |   |   |   |   |   |   |   |PDn|      |PUp|    |
   * |----------------------------------------------------------------|
   * |    |    |    |                       |   |Rst|    |Hom|PDn|End |
...
[_FL] = LAYOUT_all(
  KC_GRAVE, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_PSCR, _______, KC_INS, \
  KC_CAPS, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, _______, _______, _______, _______, _______, KC_PGUP, _______, KC_CALC, KC_HOME, \
  _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_HOME, KC_END, _______, KC_END, \
  _______, XXXXXXX, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PGDN, _______, KC_PGUP, _______, \
  _______, _______, _______, XXXXXXX, _______, XXXXXXX, _______, RESET, XXXXXXX, KC_HOME, KC_PGDN, KC_END),  
...
[_NL] = LAYOUT_all(
  TG(_NL), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PSLS, KC_P7, KC_P8, KC_P9, KC_PMNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_DEL, \
