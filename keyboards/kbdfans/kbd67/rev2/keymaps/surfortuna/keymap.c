...
[_BL] = LAYOUT_all(
  ...
  /* Keymap Fn Layer
   * ,----------------------------------------------------------------.
   * |   |F1 |F2 |F3 |F4 |F5 |F6 |F7 |F8 |F9 |F10|F11|F12|   |Rst|Ins |
   * |----------------------------------------------------------------|
   * |Caps |Mut|VDn|VUp|   |   |   |   |PSc|SLk|Pau|Up |    |Calc|Home|
   * |----------------------------------------------------------------|
...
[_FL] = LAYOUT_all(
  ...
  KC_CAPS,     KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, _______, _______, KC_PSCR, KC_SLCK, KC_PAUS,   KC_UP, _______,      KC_CALC, KC_HOME, \
